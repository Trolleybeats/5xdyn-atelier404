                    ...
                    <div class="mt-6">
                        ...
                        <div class="hidden md:block overflow-x-auto">
                            <table class="table-auto w-full">
                                <thead>
                                    <tr class="uppercase text-left bg-gray-50">
                                        ...
                                        <th class="px-4 py-3 border text-xs font-semibold text-gray-600">Date prévue</th>
                            ...
                            {{ $intervention->priorite === 'critique' ? 'bg-red-100 text-red-800' : '' }}">
                                            ...
                                            <td class="border px-4 py-3 text-gray-600">{{ $intervention->typeAppareil->nom }}</td>
                            ...
                            <div class="bg-white border border-gray-200 rounded-lg shadow-sm p-4">
                                <div class="flex justify-between items-start mb-3">
                                    <div class="flex-1">
                                        ...
                                        <p class="text-xs text-gray-600 mt-1">{{ $intervention->derniereAttribution?->user->name ?? 'Non assigné' }}</p>
                                    </div>
